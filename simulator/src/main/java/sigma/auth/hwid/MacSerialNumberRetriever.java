...
public class MacSerialNumberRetriever extends SerialNumberRetriever {
   ...
   private static void method_43028() {
      ...
      try {
         ...
         while ((var2 = var4.readLine()) != null) {
            if (((String) var2).indexOf(var3) != -1) {
               field_47615 = ((String) var2).split(var3)[1].replaceAll("\\(string\\)|(\\')", "").trim();
               break;
            }
         }
   ...
   private static void method_43029() {
      ...
      try {
         ...
         while ((var2 = var4.readLine()) != null) {
            if (((String) var2).indexOf(var3) != -1) {
               field_47615 = ((String) var2).split(var3)[1].trim();
               break;
            }
         }
      } catch (IOException var13) {
