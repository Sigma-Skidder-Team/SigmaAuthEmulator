...
public class Updates {
    ...
    public static final UpdateEntry BETA_15 =
            new UpdateEntry(
                    "5.0.0 Beta 15 (1.16.4) Update",
                    Collections.singletonList("[Error] None were found archived. Sorry guys :/")
            );

    public static final UpdateEntry BETA_14 =
            new UpdateEntry(
                    "5.0.0 Beta 14 (1.16.4) Update",
                    Arrays.asList(
    ...
    public static final UpdateEntry BETA_13 =
            new UpdateEntry(
                    "5.0.0 Beta 13 (1.16.1) Update",
                    Arrays.asList(
    ...
    public static final UpdateEntry BETA_12 =
            new UpdateEntry(
                    "5.0.0 Beta 12 (1.16.1) Update",
                    Arrays.asList(
                            "Fixed bugs",
                            "Fixed XRay",
    ...
    public static final UpdateEntry BETA_10_and_11 =
            new UpdateEntry(
                    "5.0.0 Beta 10/11 (1.16.1) Update",
                    Arrays.asList(
                            "Fixed Music Player",
                            "Fixed FakeForge",
    ...
    public static final UpdateEntry BETA_9 =
            new UpdateEntry(
                    "5.0.0 Beta 9 (1.16.1) Update",
                    Arrays.asList(
    ...
    public static final UpdateEntry BETA_8 =
            new UpdateEntry(
                    "5.0.0 Beta 8 (1.16.1) Update",
                    Arrays.asList(
                            "Updated to 1.16.1",
                            "Fixed bugs"
                    )
    ...
    public static final UpdateEntry BETA_7 =
            new UpdateEntry(
                    "5.0.0 Beta 7 (1.16) Update",
                    Arrays.asList(
                            "Updated to 1.16",
                            "Removed Optifine",
    ...
    public static final UpdateEntry BETA_6 =
            new UpdateEntry(
                    "5.0.0 Beta 6 Update",
                    Arrays.asList(
    ...
    public static final UpdateEntry BETA_5 =
            new UpdateEntry(
                    "5.0.0 Beta 5 Update",
                    Arrays.asList(
    ...
    public static final UpdateEntry BETA_4 =
            new UpdateEntry(
                    "5.0.0 Beta 4 Update",
                    Arrays.asList(
                            "Added Mineplex Fly",
    ...
    public static final UpdateEntry BETA_3 =
            new UpdateEntry(
                    "5.0.0 Beta 3 Update",
                    Arrays.asList(
    ...
    public static final UpdateEntry BETA_2 =
            new UpdateEntry(
                    "5.0.0 Beta 2 Update",
                    Arrays.asList(
